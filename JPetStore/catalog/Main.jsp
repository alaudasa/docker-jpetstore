      ...
      <logic:present name="accountBean" scope="session">
        ...
        &nbsp;
              ...
              <tr>
                ...
                <img border="0" src="../images/reptiles_icon.gif" /></html:link>
                <br><font size="2"><i>Lizards, Turtles, Snakes</i></font>
                </td>
              </tr>
              <tr>
                <td>
          ...
          <area alt="Reptiles" coords="140,270,210,340" href="viewCategory.shtml?categoryId=REPTILES" shape="RECT" />
          ...
          <img border="0" height="355" src="../images/splash-blue.gif" align="center" usemap="#estoremap" width="350" />
